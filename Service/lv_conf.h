...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "freertos_usr_lib.h"   /*Header for the dynamic memory function*/
...
#define LV_ASSERT_HANDLER sys_assert_fault_handler();   /*Halt by default*/
