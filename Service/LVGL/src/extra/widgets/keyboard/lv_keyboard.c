...
void lv_keyboard_def_event_cb(lv_event_t * e)
{
    ...
    else if(strcmp(txt, LV_SYMBOL_LEFT) == 0|| strcmp(txt, "<|") == 0) {
        lv_textarea_cursor_left(keyboard->ta);
    }
    else if(strcmp(txt, LV_SYMBOL_RIGHT) == 0|| strcmp(txt, "|>") == 0) {
        lv_textarea_cursor_right(keyboard->ta);
    }
    else if(strcmp(txt, LV_SYMBOL_BACKSPACE) == 0|| strcmp(txt, "<-") == 0) {
